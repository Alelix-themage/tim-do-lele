...
export class CardDrinksComponent implements OnInit {
  bebidas: Food[] = [
    { ID: 1, NOME: 'Coca-Cola 350ml', INGREDIENTES: 'Liquido', PRECO: 5.50 },
    { ID: 2, NOME: 'Fanta 350ml', INGREDIENTES: 'Liquido', PRECO: 5.00 },
    { ID: 3, NOME: 'Guaraná 350ml', INGREDIENTES: 'Liquido', PRECO: 5.00 },
    { ID: 4, NOME: 'Água 500ml', INGREDIENTES: 'Liquido', PRECO: 3.50 },
    { ID: 5, NOME: 'Água com Gás 500ml', INGREDIENTES: 'Liquido', PRECO: 4.00 },
  ];
